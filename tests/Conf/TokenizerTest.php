<?php
    ...
    class TokenizerTest extends PHPUnit_Framework_TestCase{
        ...
        public function testTokens1(){
            ...
            $arr = [ new Token("Application", TokenType::NS), new Token("{", TokenType::CURLY_OPEN),
        ...
        public function testTokens2(){
            ...
            $arr = [
                new Token("Application", TokenType::NS), new Token("{", TokenType::CURLY_OPEN),
                ...
                new Token("}", TokenType::CURLY_CLOSE), new Token("Application.Http", TokenType::NS),
                new Token("{", TokenType::CURLY_OPEN), new Token("Cookie configurations", TokenType::COMMENT_LINE),
                new Token("Cookie", TokenType::NS), new Token("{", TokenType::CURLY_OPEN),
                ...
                new Token("Application.Array", TokenType::NS), new Token("{", TokenType::CURLY_OPEN),
